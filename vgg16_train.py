...
best_weights = "./saved_results/Models/VGG_16/checkpoint"
vgg_model.load_weights(best_weights)
...
# Evaluate the model
loss, accuracy, top_five_accuracy, top_ten_accuracy, top_hundred_accuracy = vgg_model.evaluate(test_gen)
...
plt.close()
# summarize history for Top 100 accuracy

...
best_weights = "./saved_results/Models/ResNet_50/checkpoint"
resnet_model.load_weights(best_weights)
...
# Evaluate the model
loss, accuracy, top_five_accuracy, top_ten_accuracy, top_hundred_accuracy = resnet_model.evaluate(test_gen)
